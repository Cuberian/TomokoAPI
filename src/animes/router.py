...
@router.put("/{anime_id}/score", status_code=status.HTTP_200_OK, response_model=AnimeResponse)
async def put_anime_score_by_id(anime: AnimeResponse = Depends(valid_anime_id)):
    return {
        "anime_id": anime["anime_id"],
        "title":  anime["title"],
        "synopsis":  anime["synopsis"],
